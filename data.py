...
def pripremi_sve():
    ...
    # ali proveru uvek radimo kao deo dobre prakse u ML.
    # Ako bi NaN vrednosti postojale, morali bismo ih popuniti ili ukloniti te redove.
    ...
    # Trening skup prati svaki motor od pocetka rada do trenutka kvara.
    ...
    # uklanjamo ih iz test skupa jer trening i test moraju imati iste kolone.
    ...
    # Senzori imaju razlicite opsege vrednosti
    # Bez normalizacije, senzori sa vecim opsegom bi dominirali
    ...
    # Senzorska merenja su zasumljena vrednost u jednom ciklusu moze biti anomalija.
    # min_periods=1 resava problem prvih ciklusa koji nemaju prethodnih 5 vrednosti.
    # broj atributa se duplira za svaki senzor dodajemo _roll5 varijantu.
    ...
    # Koristimo poslednjih 20 motora (81-100) za validaciju.
...
def ucitaj_za_vizualizacije():
    ...
    # kako bi grafici bili fizicki interpretabilni.
